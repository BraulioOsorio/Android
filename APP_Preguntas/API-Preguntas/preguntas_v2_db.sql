...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-02-2024 a las 03:26:42
...
--
CREATE DATABASE IF NOT EXISTS `preguntas_v2_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `preguntas_v2_db`;
...
(40, 2, 0, 0, 0, '2024-02-02 16:00:29', NULL),
(41, 1, 0, 0, 0, '2024-02-03 15:38:07', NULL),
(42, 1, 0, 0, 0, '2024-02-04 18:55:02', NULL),
(43, 1, 0, 0, 0, '2024-02-04 18:55:04', NULL),
(44, 1, 0, 0, 0, '2024-02-04 19:04:50', NULL);
...
(48, 39, 6, 'Modelo-Visa', 'ERROR', '2024-01-26 07:26:56'),
...
(53, 39, 1, 'Hyperlink', 'ERROR', '2024-01-26 07:32:33'),
(54, 39, 9, 'Mercurial', 'ERROR', '2024-01-26 07:32:48'),
(55, 39, 2, 'C++', 'ERROR', '2024-01-26 07:32:50'),
(56, 39, 8, 'Estructura de control de iteración', 'OK', '2024-01-26 07:32:52');
...
DELIMITER //
CREATE TRIGGER after_insert_respuestas
AFTER INSERT ON respuestas
FOR EACH ROW
BEGIN
  DECLARE estado_respuesta VARCHAR(10);
  DECLARE cant_ok_increment INT;
  DECLARE cant_error_increment INT;

  -- Obtener el estado de la respuesta insertada
  SET estado_respuesta = NEW.estado;

  -- Determinar los incrementos para cant_ok y cant_error
  IF estado_respuesta = 'OK' THEN
    SET cant_ok_increment = 1;
    SET cant_error_increment = 0;
  ELSE
    SET cant_ok_increment = 0;
    SET cant_error_increment = 1;
  END IF;

  -- Actualizar la tabla cuestionarios
  UPDATE cuestionarios
  SET
    cant_ok = cant_ok + cant_ok_increment,
    cant_error = cant_error + cant_error_increment
  WHERE id = NEW.id_cuestionario;
END;
//
DELIMITER ;
...
(2, 'Winder', 'winder@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b');
